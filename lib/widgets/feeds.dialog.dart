...
class FeedDialog extends StatelessWidget {
      ...
      child: SingleChildScrollView(
        child: Column(children: [
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                ...
                child: dialogContent(
                    ...
                    () => {
                          favsProvider.addAndRemoveFromFav(
                              productId, prodAttr.price, prodAttr.title, prodAttr.imageUrl),
              ...
              Flexible(
                child: dialogContent(
                    ...
                    1,
                    () => {
                          Navigator.pushNamed(context, ProductDetails.routeName, arguments: prodAttr.id)
          ...
          Container(
            ...
            decoration: BoxDecoration(border: Border.all(color: Colors.white, width: 1.3), shape: BoxShape.circle),
            child: Material(
  ...
  Widget dialogContent(BuildContext context, int index, Function fct) {
    ...
    List<IconData> _dialogIcons = [
      favs.getFavItems.containsKey(productId) ? Icons.favorite : Icons.favorite_border,
      Feather.eye,
      AppIcons.cart,
    ];

    List<String> _texts = [
      favs.getFavItems.containsKey(productId) ? 'In wishlist' : 'Add to wishlist',
      'View product',
      cart.getCartItems.containsKey(productId) ? 'In Cart ' : 'Add to cart',
    ];
    List<Color> _colors = [
      favs.getFavItems.containsKey(productId) ? Colors.red : Theme.of(context).textSelectionColor,
