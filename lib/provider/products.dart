...
class Products with ChangeNotifier {
  ...
  List<Product> _products = [
    ...
    Product(
        ...
        brand: 'No brand',
        productCategoryName: 'Beauty and HealthCare',
        quantity: 8515,
        isPopular: false),
    Product(
  ...
  List<Product> findByBrand(String brandName) {
    List _categoryList =
        _products.where((element) => element.brand.toLowerCase().contains(brandName.toLowerCase())).toList();
  ...
  List<Product> searchQuery(String searchText) {
    List _productList =
        _products.where((element) => element.title.toLowerCase().contains(searchText.toLowerCase())).toList();
