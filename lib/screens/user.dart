...
class _UserInfoState extends State<UserScreen> {
  ...
  void getData() async {
    ...
    final DocumentSnapshot userDoc =
        user.isAnonymous ? null : await FirebaseFirestore.instance.collection('users').doc(_uid).get();
    if (userDoc == null) {
      return;
    } else {
      setState(() {
            ...
            slivers: <Widget>[
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    Padding(padding: const EdgeInsets.only(left: 8.0), child: userTitle(title: 'User Bag')),
                    Divider(
                      thickness: 1,
                      color: Colors.grey,
                    ),
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          ...
                          leading: Icon(AppIcons.wishlist),
                        ),
                      ),
                    ),
                    ListTile(
