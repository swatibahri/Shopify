...
import 'package:store_app/models/orders_attrs.dart';
...
class _OrderFullState extends State<OrderFull> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () => Navigator.pushNamed(context, ProductDetails.routeName, arguments: orderAttrProvider.productId),
      child: Container(
        height: 150,
                      ...
                      children: [
                        ...
                        Material(
                          ...
                          child: InkWell(
                            ...
                            // splashColor: ,
                            onTap: () {
                              globalMethods.showDialogBox('Remove order!', 'Order will be deleted!', () async {
                                setState(() {
                                  _isLoading = true;
                                });
