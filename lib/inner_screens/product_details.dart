...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final productAttrs = productData.findById(productId);
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
            ...
            child: Image.network(productAttrs.imageUrl),
          ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _details(themeState.darkTheme, 'Brand: ', productAttrs.brand),
                      _details(themeState.darkTheme, 'Quantity: ', '${productAttrs.quantity}'),
                      _details(themeState.darkTheme, 'Category: ', productAttrs.productCategoryName),
                      _details(
                          themeState.darkTheme, 'Popularity: ', productAttrs.isPopular ? 'Popular' : 'Barely known'),
                      SizedBox(
                        height: 15,
                      ),
                      Divider(
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) {
                      return ChangeNotifierProvider.value(value: productList[index], child: FeedProducts());
                    },
                  ),
                ),
              ],
                      ...
                      onPressed: cartProvider.getCartItems.containsKey(productId)
                          ...
                          : () {
                              cartProvider.addProductToCart(
                                  productId, productAttrs.price, productAttrs.title, productAttrs.imageUrl);
                            },
                      child: Text(
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      child: Center(
                        child: Icon(
                          favProvider.getFavItems.containsKey(productId) ? Icons.favorite : AppIcons.wishlist,
                          color: favProvider.getFavItems.containsKey(productId) ? Colors.red : ColorsConsts.white,
                        ),
                      ),
                    ),
                  ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            title,
            style: TextStyle(color: Theme.of(context).textSelectionColor, fontWeight: FontWeight.w600, fontSize: 21.0),
          ),
          Text(
            info,
            style: TextStyle(
              fontWeight: FontWeight.w400,
              fontSize: 20.0,
              color: themeState ? Theme.of(context).disabledColor : ColorsConsts.subTitle,
            ),
          ),
        ],
      ),
