...
class ContentSpace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final productsBrandList = productsData.findByBrand(brand);
    if (brand == 'All') {
      for (int i = 0; i < productsData.products.length; i++) {
        productsBrandList.add(productsData.products[i]);
      }
    }
    return Expanded(
      child: Padding(
