            ...
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: NetworkImage(productAttributes.imageUrl), fit: BoxFit.contain),
                  borderRadius: BorderRadius.all(Radius.circular(10.0)),
                  boxShadow: [BoxShadow(color: Colors.grey, offset: Offset(2.0, 2.0), blurRadius: 2.0)],
                ),
              ),
            ),
            FittedBox(
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: Theme.of(context).backgroundColor,
                    borderRadius:
                        BorderRadius.only(bottomRight: Radius.circular(10.0), topRight: Radius.circular(10.0)),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      maxLines: 4,
                      style: TextStyle(fontWeight: FontWeight.w700, color: Theme.of(context).textSelectionColor),
                    ),
                    SizedBox(
                      height: 20.0,
                    ),
                    ...
                    Text(productAttributes.productCategoryName, style: TextStyle(color: Colors.grey, fontSize: 18.0)),
                    SizedBox(
                      height: 20.0,
                    ),
                  ],
